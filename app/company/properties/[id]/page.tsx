  ...
  return (
    <div
      className={[
        ...
        "shadow-none transition hover:-translate-y-px hover:shadow-(--oboon-shadow-card)",
      ].join(" ")}
    >
...
export default function PropertyDetailPage() {
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- load() syncs remote data into local state.
    load();
  }, [load]);
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
                ...
                <div className="md:col-span-3">
                  <div className="rounded-lg bg-(--oboon-bg-subtle)/40 px-3 py-2">
                    ...
                    <p
                      className={cn(
                        "mt-2 text-sm leading-relaxed text-(--oboon-text-title)",
