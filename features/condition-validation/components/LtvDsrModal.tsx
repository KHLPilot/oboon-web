...
const LOAN_REJECTION_OPTIONS: { value: "none" | "yes"; label: string }[] = [
  { value: "none", label: "없음" },
  { value: "yes", label: "있음" },
];
...
export default function LtvDsrModal({
  ...
  const [loanRejection, setLoanRejection] = useState<"none" | "yes" | null>(null);
  ...
  const resolvedLoanRejection: "none" | "yes" = loanRejection ?? "none";
  ...
  return (
    <Modal open={open} onClose={onClose} size="md" panelClassName="w-[min(100%-2rem,480px)]">
