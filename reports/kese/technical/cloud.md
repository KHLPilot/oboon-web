...
| CL-05 | 스토리지 공개 접근 | 취약 | Cloudflare R2 버킷의 퍼블릭 도메인(`CLOUDFLARE_R2_PUBLIC_URL`) 설정 존재. 계약서·신분증 등 민감 파일의 접근 정책 확인 필요 |
...
| 우선순위 | 항목 | 조치 내용 |
|---------|------|----------|
| HIGH | CL-05 | R2 버킷 공개 접근 설정 확인, 민감 파일(`pdf-temp/`, 신분증) 서명 URL 전용 접근 강제 |
